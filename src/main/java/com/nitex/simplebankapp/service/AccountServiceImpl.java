...
public class AccountServiceImpl implements AccountService{
    ...
    @Autowired
    public AccountServiceImpl(PasswordEncoder encoder, AuthenticationManager authenticationManager,
    ...
    public AccountInfoResponse getAccountInfo(String accountNumber) {
        ...
        if (ExistingAccount == null ) {
            ...
            response.setAccountResponse(new AccountResponse(ExistingAccount.getAccountNumber(), ExistingAccount.getAccountName(), ExistingAccount.getBalance()));
    ...
    public TransactionResponse withdraw(WithdrawalRequest request) throws Exception {
        ...
        AccountLoginResponse loggedStatus = loginAccount(login);
    ...
    public AccountLoginResponse loginAccount(AccountLoginRequest loginRequest) throws Exception {
        try {
            ...
            accountRepository.findByAccountNumber(loginRequest.getAccountNumber());
